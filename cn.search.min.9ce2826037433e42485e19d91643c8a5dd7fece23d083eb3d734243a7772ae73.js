...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/notes/flexsearch.min.js');loadScript('/notes/cn.search-data.min.3d80bd543867031179782893c37e5da0cae465a7d863b84910a9e721bd3ab5a3.js',function(){input.required=false;search();});}
