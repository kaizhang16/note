...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/notes/flexsearch.min.js');loadScript('/notes/cn.search-data.min.598ed9cedcfb4a80a01acbc5362f748baa97d3ddd5b68f8379cc1eb3ff571089.js',function(){input.required=false;search();});}
