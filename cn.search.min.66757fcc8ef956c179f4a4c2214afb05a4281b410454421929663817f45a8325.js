...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/notes/flexsearch.min.js');loadScript('/notes/cn.search-data.min.35900dcb547b5a1ef2d1dd8d39606f2562f7e0c668d5f8b2310186354cf4a479.js',function(){input.required=false;search();});}
