...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/notes/flexsearch.min.js');loadScript('/notes/cn.search-data.min.2c1cedeadf30a0545de8942634fcbb75edfc9049e6e9a88f146aae149d3552e9.js',function(){input.required=false;search();});}
