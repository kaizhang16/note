...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/notes/flexsearch.min.js');loadScript('/notes/cn.search-data.min.919df1bd15036dbe13553785dd46cbc3886c5616e39f40a09229e6aa3402bff4.js',function(){input.required=false;search();});}
