...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/notes/flexsearch.min.js');loadScript('/notes/cn.search-data.min.855647837f9bddad6f09ed8f44a77103e74a8be8bf29a01c9b200812a4389405.js',function(){input.required=false;search();});}
